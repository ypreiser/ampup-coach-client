      ...
      <div className={styles.small}>
        <div className={styles.inputContainer}>
          ...
          <input
            ...
            value={product.amountPerChallenge}
            onChange={handleChange}
          />
        </div>
        <div className={styles.inputContainer}>
        ...
        <div className={styles.inputContainer}>
          ...
          <input
            ...
            value={product.groupPointsToAvailability}
            onChange={handleChange}
          />
        </div>
      </div>
